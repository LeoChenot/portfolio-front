              ...
              <div className="content__projects__project__inner__content" style={{ '--firstColor': '#2FB6C8', '--secondColor': '#2FB6C8' }}>
                <div className="content__projects__project__inner__content__front">
                  <div className="content__projects__project__inner__content__front__content">
                    ...
                    <img className="content__projects__project__inner__content__front__content__img" src="https://images.weserv.nl/?url=https://raw.githubusercontent.com/LeoChenot/LeoChenot/main/img/Collectio.png&h=137" alt="page d'accueil du projet Collectio" />
              ...
              <div className="content__projects__project__inner__content" style={{ '--firstColor': '#008BAD', '--secondColor': '#008BAD' }}>
                <div className="content__projects__project__inner__content__front">
                  <div className="content__projects__project__inner__content__front__content">
                    ...
                    <img className="content__projects__project__inner__content__front__content__img" src="https://images.weserv.nl/?url=https://raw.githubusercontent.com/LeoChenot/LeoChenot/main/img/Timers2.png&h=137" alt="page d'accueil du projet Timers" />
                    <button className="content__projects__project__inner__content__front__content__btn" type="button">
                      En savoir plus...
                    </button>
                  </div>
              ...
              <div className="content__projects__project__inner__content" style={{ '--firstColor': '#FF7D1A', '--secondColor': '#FF7D1A' }}>
                <div className="content__projects__project__inner__content__front">
                  <div className="content__projects__project__inner__content__front__content">
                    ...
                    <img className="content__projects__project__inner__content__front__content__img" src="https://images.weserv.nl/?url=https://cdn.discordapp.com/attachments/657342275210444828/1058016741961244772/integration-e-commerce.netlify.app_.png&h=137" alt="page d'accueil du projet Sneakers" />
                    <button className="content__projects__project__inner__content__front__content__btn" type="button">
                      En savoir plus...
                    </button>
                  </div>
